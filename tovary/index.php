...
<div class="page_products">
	<div class="page_products-content container">
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("M2","COLOR",""),
		...
		"FILTER_NAME" => "filter",
		"FILTER_PRICE_CODE" => array("rozn"),
		"FILTER_PROPERTY_CODE" => array("M2","COLOR",""),
		...
		"LIST_PROPERTY_CODE" => array("M2","COLOR",""),
		"LIST_PROPERTY_CODE_MOBILE" => array("M2","COLOR"),
		"LIST_SHOW_SLIDER" => "Y",
		...
		"SEF_FOLDER" => "/tovary/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"compare.php?action=#ACTION_CODE#","element"=>"#SECTION_CODE#/#ELEMENT_CODE#/","section"=>"#SECTION_CODE#/","sections"=>"/tovary/","smart_filter"=>"#SECTION_CODE#/filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "N",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
		...
		"TOP_PROPERTY_CODE" => array(0=>"M2",1=>"COLOR",2=>"",),
